...
const OpticalBench: React.FC<OpticalBenchProps> = ({
  ...
  return (
    <div className="w-full h-full bg-slate-950 relative overflow-hidden select-none">
      ...
      {/* Reset/Info Overlay */}
      <div className="absolute top-4 left-4 z-10 text-slate-400 text-xs md:text-sm max-w-[200px] pointer-events-none">
        <h1 className="font-bold text-white text-lg mb-1">Optics Lab</h1>
        <p>Drag <span className="text-cyan-400 font-bold">blue handle</span> to rotate mirror.</p>
